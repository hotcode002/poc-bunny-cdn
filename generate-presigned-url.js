...
let videoId = "5a603ce5-6091-4dce-a0cc-49bc295fee87";

let playlist = "playlist.m3u8"
...
console.log(`${signedUrl}/${playlist}`);

// Test the signedUrl with https://developer-tools.jwplayer.com/stream-tester
